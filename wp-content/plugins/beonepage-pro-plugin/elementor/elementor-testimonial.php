...
class Widget_My_Custom_Elementor_Testimonial extends Widget_Base {
	...
	protected function _register_controls() {
		...
		//Title
		$beonepage_testimonial_module_title = beonepage_olddata_fetch_redux('front_page_testimonial_module_title', 'option');
		...
		//Caption Animation
		$beonepage_testimonial_module_animation = beonepage_olddata_fetch_redux('front_page_testimonial_module_animation', 'option');
		...
		// Font Color
		$beonepage_testimonial_module_color = beonepage_olddata_fetch_redux('front_page_testimonial_module_color', 'option');
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .module-caption, {{WRAPPER}} blockquote p, {{WRAPPER}} .testimonial-name span' => 'color: {{VALUE}}',
				],
				'section' 	=> 'elementor_testimonial',
			]
		);
		//Separator Line & Dots Color
		$beonepage_testimonial_module_sp_color = beonepage_olddata_fetch_redux('front_page_testimonial_module_sp_color', 'option');
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .separator span:before, .separator span:after' => 'color: {{VALUE}}',
					'{{WRAPPER}} .owl-dot span, .testimonial-module .owl-dot:after' => 'Background-color: {{VALUE}}',
				],
				'section' 	=> 'elementor_testimonial',
			]
		);
		//Separator Circle & Active Dot Color
		$beonepage_testimonial_module_sp_i_color = beonepage_olddata_fetch_redux('front_page_testimonial_module_sp_i_color', 'option');
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .separator i, {{WRAPPER}} .testimonial-box blockquote:before, {{WRAPPER}} .testimonial-name' => 'color: {{VALUE}}',
					'{{WRAPPER}} .owl-dot.active:after' => 'Background-color: {{VALUE}}',
				],
				'section' 	=> 'elementor_testimonial',
			]
		);
		//Testimonial Box Background Color
		$beonepage_testimonial_module_box_array = beonepage_olddata_fetch_redux('front_page_testimonial_module_box', 'option');
		if(!empty($beonepage_testimonial_module_box_array)){
			$beonepage_testimonial_module_box_array = beonepage_olddata_fetch_redux('front_page_testimonial_module_box', 'option');
				$beonepage_testimonial_module_box =  $beonepage_testimonial_module_box_array['rgba'];
		}else{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .testimonial-box blockquote' => 'Background-color: {{VALUE}}',
				],
				'section' 	=> 'elementor_testimonial',
			]
		...
		$class = '';
		$attribute = '';    
        $beonepage_testimonial_module_bg = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg', 'option');
		...
		//Background color
		$beonepage_testimonial_module_bg_color = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_color', 'option');
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .testimonial-module' => 'background-color: {{VALUE}}',
				],
				'condition' => [
        ...
        //Background image 
        $beonepage_testimonial_module_bg_img = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_testimonial_module_bg_img_rp = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_testimonial_module_bg_img_bp = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_testimonial_module_bg_img_bs = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_img', 'option');
        ...
        $beonepage_testimonial_module_bg_img_ath = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_img', 'option');
        ...
        $beonepage_testimonial_module_bg_video = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_video', 'option');
		if(!empty($beonepage_testimonial_module_bg_video)){
			$beonepage_testimonial_module_bg_video = beonepage_olddata_fetch_redux('front_testimonial_module_table_module_bg_video', 'option');
        ...
        //Parallax seting
        $beonepage_testimonial_module_bg_parallax = beonepage_olddata_fetch_redux('front_page_testimonial_module_bg_parallax', 'option');
